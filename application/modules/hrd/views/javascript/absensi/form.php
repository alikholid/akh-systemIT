		...
		$.ajax({
			...
			success: function(data){
				...
				//purchase_order_open_form = 1;
					//alert('http://localhost:8083/SIPOP/'+data[0].karyawan_link_photo);		
                 // };		
			    // document.getElementById('gambar').innerHTML = '<img src="http://localhost:8083/SIPOP/' + data[0].karyawan_link_photo + '">'; 
