						...
						<div class="col-xl-12">
							<div id="accordion">
								<div class="card">
									<div class="card-header" id="headingOne">
								     ...
								     <div class="tab tab-border">
											<ul class="nav nav-tabs form_tab_<?php echo $methodid ?>" role="tablist">
												...
												<li class="nav-item">
													<a class="nav-link" id="tab_<?php echo $methodid; ?>_outgoing" data-toggle="tab" href="#content_<?php echo $methodid; ?>_laporan" role="tab" aria-controls="content_<?php echo $methodid; ?>_laporan" aria-selected="true">
								   ...
								   <div  class="collapse show" data-parent="#accordion" id="content_<?php echo $methodid; ?>_report" role="tabpanel"  aria-labelledby="tab_<?php echo $methodid; ?>_report">  
								  <div class="row">
								  <div class="col-xl-12">
								   <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
								   <div class="card-body">
									   <form class="ui grid ecc_form" id="form_echo $methodid ?>">
												...
												<div class="col-xl-8">
												 <?php 
					                                $this->ecc_library->form2('select_pop_line','Departement',"form_".$methodid,'karyawan_departemen1','','','get_departemen1','4');
			                                     ?>
												 </div>
												 <div class="col-xl-8">
												 <?php 
					                                $this->ecc_library->form2('select_pop_line','Divisi',"form_".$methodid,'karyawan_departemen2','','','get_departemen2','4');
			                                     ?>
												 </div>
												  <div class="col-xl-8">
												 <?php 
					                                $this->ecc_library->form2('select_pop_line','Sub Divisi',"form_".$methodid,'karyawan_departemen3','','','get_departemen3','4');
			                                     ?>
												 </div>
												   ...
												   <div class="form-group form-inline row">
												     <label for="inputPassword6"  class="col-sm-4 col-form-label">Date  &nbsp </label>
														<div class="input-group">
															...
															<input class="form-control" id="form_<?php echo $methodid ?>_date_report_1"  name="date_report_1" type="text" value="<?php echo date("Y-m-d") ?>" />
														</div>
									...
									<div  class="collapse show" data-parent="#accordion" id="content_<?php echo $methodid; ?>_laporan" role="tabpanel"  aria-labelledby="tab_<?php echo $methodid; ?>_laporan">
									</div>
