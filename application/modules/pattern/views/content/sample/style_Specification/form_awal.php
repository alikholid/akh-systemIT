		...
		//$this->ecc_library->form('select','Order Type',"form_".$methodid,'purchase_order_type_id','','','purchase_order_type_purchase');
						 ...
						 <div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
							<div class="row panel_<?php echo $methodid ?>_panel_detail">
								<div class="col-xl-12">
								 <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_detail" action="javascript:add_<?php echo $methodid ?>_detail()">
										<?php 
											$this->ecc_library->form('hidden','',"form_".$methodid."_detail",$this->security->get_csrf_token_name(),$this->security->get_csrf_hash());
											$this->ecc_library->form('text','',"form_".$methodid."_detail",'style_spec_header_id','','','');
										 ...
										 <div class="row">
										    <div class="col-xl-8">
											    <div class="row">
											       <div class="col-xl-4">
													 <?php 
													 $this->ecc_library->form('select_pop','Size',"form_".$methodid."_detail",'style_spec_detail_size_id','','','size');
												      ?>
												    </div>
													<div class="col-xl-3">
													 <?php 
													 $this->ecc_library->form('select_pop','Unit',"form_".$methodid."_detail",'uom_id','71','','uom');
												      ?>
												    </div>
											    </div>
										       </div>
										...
										<div class="row">
											<div class="col-xl-4">
											  <div class="row">
											    <div class="col-xl-8">
												   <?php 
												  //	$this->ecc_library->form('select_pop','Point Of Measure',"form_".$methodid,'nikah_id','','','plh_nikah');
													$this->ecc_library->form('text','Point Of Measure',"form_".$methodid."_detail",'point_of_measure','');												 	?>
												 </div>
													...
													<div class="col-xl-8">
													    ...
													    <div class="form-group">
				                                              <div class="form-check form-check-inline">
                                                               ...
                                                               <label class="form-check-label" for="inlineCheckbox1">HPS</label>
                                                               </div>
                                                               <div class="form-check form-check-inline">
                                                                 <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
                                                                 <label class="form-check-label" for="inlineCheckbox2">CENTER</label>
                                                               </div>
                                                        </div>
								       ...
								       <div class="col-xl-4">
								            <div class="row">
									           <div class="ui grid form">
										           <div class="row field">
										           	<div class="twelve wide column">
										           		<button type="button" class="btn btn-success" onclick="copy_<?php echo $methodid ?>_spec_awal()">
										           			<i class="fa fa-clone"></i> Copy Specification
										           		</button>
									...
									<!-- <div class="row" style="margin-top:8px;"> -->
								     <!--  <div class="col-xl-12">-->
									   <?php 
									 //  style_spec_header_id
								    	//print_r($dashboard_table);
										//style_spec_header_id
										//style_spec_detail_id
							//	$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'style_spec_header_id','form_id' => 'form_'. $methodid .'_detail_style_spec_header_id')));
										//print_r($extra_param);
							//			$this->ecc_library->jqgrid($methodid."_detail", $dashboard_table['field_detail'], $dashboard_table['field_detail_loaddata'],$extra_param); 
									...
									<div class="row" style="margin-top:8px;" >
								      <div class="col-xl-12">
									  	<div class="row">
										    <div class="col-xl-8">
											 <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_detail_spec">
											   <div class="row">
                                                   ...
                                                   <div class="twelve wide column col-xl-3" style="margin-top:24px;">
										               <button type="button" class="btn btn-success" onclick="copy_<?php echo $methodid ?>_spec()">
										               	<i class="fa fa-plus"></i> Add
										               </button>
											...
											// print_r($_POST);
									         ?>
										        ...
										        <div class="row" style="margin-top:8px;" id="tbl_spec_temp">
													<div class="col-xl-12 grid_container_<?php echo $methodid ?>_detail_spec_temp">
														<table id="table_<?php echo $methodid ?>_detail_spec_temp"></table>
								                        <div id="ptable_<?php echo $methodid ?>_detail_spec_temp"></div>                                                      
													</div>
												</div>
