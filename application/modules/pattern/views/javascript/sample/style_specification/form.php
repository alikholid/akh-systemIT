	...
	$(function () {
	  ...
	  $("#table_<?php echo $methodid ?>_detail_spec").jqGrid({
			...
			//   },
			   ...
			   {name:'r5',index:'r5', width:30,editable: true,"searchoptions":{"clearSearch":false}},
			   {name:'r6',index:'r6', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink',
			      formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 ...
						 //$("#table_<?php echo $methodid ?>_detail_spec").jqGrid ('setcell', 5, 'BASIC', {'background-color':'#ff6347'});
					//fontColorFormat_basic	  
			   ...
			   {name:'r7',index:'r7', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink', 
			   	formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 var row = jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid('getRowData');
                       	 var spec_id = row[rowId-1]['r1'];
						 ...
						 $('#form_<?php echo $methodid ?>_formula_uraian').val(uraian);
						 $('#form_<?php echo $methodid ?>_formula_nilai_info').val(nilai_info);
						 //  jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid ('setcell', 6,'SIZE XS','dd');
						//$("#table_<?php echo $methodid ?>_detail_spec").setcell(6,'SIZE XS','0.5', {'color':'#ff6347'});
			   ...
			   {name:'r8',index:'r8', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink',
			   formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 var row = jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid('getRowData');
                       	 var spec_id = row[rowId-1]['r1'];
			   ...
			   {name:'r9',index:'r9', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink',
			     formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 var row = jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid('getRowData');
                       	 var spec_id = row[rowId-1]['r1'];
			   ...
			   {name:'r10',index:'r10', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink',
			     formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 var row = jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid('getRowData');
                         var spec_id = row[rowId-1]['r1'];
			   ...
			   {name:'r11',index:'r11', width:30,"searchoptions":{"clearSearch":false},formatter:'dynamicLink',
			     formatoptions: {
					  onClick: function (cellValue, rowId, rowData,e){
						 var row = jQuery("#table_<?php echo $methodid ?>_detail_spec").jqGrid('getRowData');
                         var spec_id = row[rowId-1]['r1'];
			    ...
			    {name:'kode',index:'kode', width:90, editable:false,
		...
		//	pager: '#ptable_<?php echo $methodid ?>_detail_spec',
			...
			loadComplete: function () {
               ...
               //   $("#table_<?php echo $methodid ?>_detail_spec").setCell(6, 'SIZE XS', '', {'background-color':'#ff6347'});
				 
			   // console.log(rowsDatax);
			    //alert(rowsData);
			    ...
			    //console.log(rowData[i]);
				 ...
				 }else if (rowData[i].r3 === 'M'){
					  $("#table_<?php echo $methodid ?>_detail_spec").jqGrid("setLabel","r5","BASIC M");
					  //alert("EDIT");
				 }else{
					    $("#table_<?php echo $methodid ?>_detail_spec").jqGrid("setLabel","r5","BASIC L");
				  }
