<script type="text/javascript">  
	...
	{	
		...
		//$("#tab_<?php echo $methodid; ?>_dokumen").addClass("tab_disabled");
		   ...
		   // $("#tab_<?php echo $methodid; ?>_detail_add").hide();
			...
			// $("#tbl_spec_temp").append('<div class="col-xl-12 grid_container_<?php echo $methodid ?>_detail_spec_temp"> <table id="table_<?php echo $methodid ?>_detail_spec_temp"></table>  <div id="ptable_<?php echo $methodid ?>_detail_spec_temp"></div></div>');
