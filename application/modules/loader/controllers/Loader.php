...
Class Loader extends CI_Controller { 
	...
	function index() {
		...
		$data_list['data_style_specification_edit'] = array('view' => 'dbo.view_spec_header','view_detail' => 'dbo.view_spec_detail','view_trims' => 'dbo.view_style_spec_trim','detail_session_seq' => 'style_spec_header_id_seq', 'key' => 'style_spec_header_id');
