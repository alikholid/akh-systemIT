<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row main-navbar">
			
	<div class="text-left navbar-brand-wrapper">
		<a class="navbar-brand brand-logo" href="<?php echo base_url() ?>"><img src="<?php echo BASEDIR . "assets/" . $path_template ."/" ?>images/logo-popstar.png" alt="" ></a>
		<a class="navbar-brand brand-logo-mini" href="<?php echo base_url() ?>"><img src="<?php echo BASEDIR . "assets/" . $path_template ."/" ?>images/logo-icon-dark.png" alt=""></a>
	</div>
	...
	<ul class="nav navbar-nav mr-auto">
		...
		<li style="margin:auto;padding-left:50px">
			<p class="mt-25 mb-0"><b>SISTEM INFORMASI POPSTAR</b></p>
		</li>
	</ul>

	<ul class="nav navbar-nav ml-auto">
		<li class="nav-item fullscreen">
			<a id="btnFullscreen" href="javascript:void();" class="nav-link" ><i class="ti-fullscreen"></i></a>
		</li>
		<!--
		...
		<li class="nav-item dropdown mr-30">
			<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
				<img src="<?php echo BASEDIR . "assets/" . $path_template ."/" ?>images/profile-avatar.jpg" alt="avatar">
			</a>
			<div class="dropdown-menu dropdown-menu-right">
				<div class="dropdown-header">
					<div class="media">
						<div class="media-body">
							<h5 class="mt-0 mb-0"><?php echo $this->session->userdata('username') ?></h5>
				...
				<div class="dropdown-divider"></div>
				<!--
				<a class="dropdown-item" href="javascript:add_tab(460,'Change Password','users/security','fa fa-lock');">
					<i class="text-secondary ti-lock"></i>Change Password
				</a>
				...
				<a class="dropdown-item" href="#"><i class="text-info ti-user"></i>Account Information</a>
				<a class="dropdown-item" href="#"><i class="text-info ti-lock"></i>Change Password</a>
				!-->
				<a class="dropdown-item" href="javascript:logout();">
					<i class="text-danger ti-power-off"></i>Logout
				</a>
			</div>
		</li>
	</ul>
