...
({
				...
				getImageSrcs : function (e) {
					if (this.sources = [], "undefined" != typeof e && (this.findImageInElement(e), this.deepSearch === !0))
						for (var t = e.querySelectorAll("*"), n = 0; n < t.length; n++)
							"SCRIPT" !== t[n].tagName && this.findImageInElement(t[n]);
					return this.sources
				},
				findAndPreload : function (e) {
					if ("undefined" != typeof e) {
						...
						for (var t = 0; t < this.sources.length; t++) {
							...
							n.preload(this.imageLoaded.bind(this)),
							this.images.push(n)
						}
					}
				},
					...
					if (!this.hasGradient(t.url)) {
						...
						for (var n = t.url.split(", "), i = 0; i < n.length; i++)
							if (this.validUrl(n[i]) && this.urlIsNew(n[i])) {
								var r = "";
								(this.isIE() || this.isOpera()) && (r = "?rand=" + Math.random()),
								this.sources.push(n[i] + r)
							}
					}
				},
	...
	4 : [function (e, t, n) {
			...
			r = {
				...
				updateProgress : function (e, t) {
					0 !== t && this.setTransitionTime(t),
					e = i(e),
					this.element.style.width = e + "%"
				},
				setTransitionTime : function (e) {
					this.element.style.WebkitTransition = "width " + e + "ms",
					this.element.style.MozTransition = "width " + e + "ms",
					this.element.style.OTransition = "width " + e + "ms",
					this.element.style.MsTransition = "width " + e + "ms",
					this.element.style.Transition = "width " + e + "ms"
				}
			};
			t.exports = function () {
				var e = Object.create(r);
				return e.element = null,
				e.className = "queryloader__overlay__bar",
				e.barHeight = 1,
				e.barColor = "#fff",
				e
			}
	...
	5 : [function (e, t, n) {
			...
			t.exports = function () {
				var e = Object.create(r);
				return e.element = null,
				e.idName = "qlPercentage",
				e.className = "queryloader__overlay__percentage",
				e.barHeight = 1,
				e.barColor = "#fff",
				e
			}
	...
	7 : [function (e, t, n) {
			...
			o = {
				init : function () {
					...
					this.showPercentage && (this.percentage = r(), this.percentage.barColor = this.barColor, this.percentage.idName = this.percentageId, this.percentage.create(), this.element.appendChild(this.percentage.element)),
				...
				calculatePosition : function () {
					var e = "absolute";
					return "body" === this.parentElement.tagName.toLowerCase() ? e = "fixed" : ("fixed" !== this.parentElement.style.position || "absolute" !== this.parentElement.style.position) && (this.parentElement.style.position = "relative"),
					e
				},
				updateProgress : function (e, t) {
					null !== this.loadingBar && this.loadingBar.updateProgress(e, t),
					null !== this.percentage && this.percentage.updateProgress(e, t)
				},
				remove : function () {
			...
			t.exports = function (e) {
				...
				return t.parentElement = e,
				t.idName = "qLoverlay",
				t.percentageId = "qlPercentage",
				t.className = "queryloader__overlay",
				t.element = null,
				t.loadingBar = null,
				t.percentage = null,
				t.barColor = "#ff0000",
			...
			t.exports = function () {
				var e = window.setInterval(function () {
						if ("undefined" != typeof document.getElementsByTagName("body")[0]) {
							...
							t.style.left = "0",
							t.style.top = "0",
							t.setAttribute("id", "qLtempOverlay"),
	...
	10 : [function (e, t, n) {
			...
			o = {
				init : function (e, t) {
					...
					"undefined" != typeof this.element && (this.createOverlay(), this.removeTempOverlay(), this.createPreloader(), this.startMaxTimeout())
				},
				extend : function (e, t) {
				...
				updateProgress : function (e, t) {
					var n = e / t * 100;
					this.overlay.updateProgress(n, this.options.minimumTime),
					"function" == typeof this.options.onProgress && this.options.onProgress(n, e, t),
					e === t && this.done === !1 && (window.clearTimeout(this.maxTimeout), window.setTimeout(this.doneLoading.bind(this), this.options.minimumTime))
				},
