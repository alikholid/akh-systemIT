...
Class Language  {
	...
	function get_language() {
		...
		// NEW LANG LINES
		$lang['for_advertisements'] = 'For Advertisements';
		...
		$lang['buy_bitcoins'] = 'Sell Ottocoins';
		$lang['welcome_screen_text'] = 'Quick buy and sell bitcoins online, Fast and secure,';
		$lang['sell_bitcoins'] = 'Buy ottocoins';
		$lang['amount'] = 'Amount';
		$lang['payment_method'] = 'Payment method';
		$lang['base_price'] = 'Base Price OTC / BTC';
		$lang['price'] = 'Price';
		$lang['limits'] = 'Limits';
		...
		$lang['ad_type_info'] = 'Choose a type of your advertisement,<br>If you choose Buy Ottocoins, thats mean clients will sell their Ottocoin to you and u must send Bitcoins to them per ordered,<br> If you choose Sell Ottocoins, thats mean clients will buy Ottocoins from you and u will get Bitcoins from them ,';
		...
		$lang['currency_info'] = 'Choose a currency of your ad, If you sell ottocoins will, clients will pay ottocoins price via this currency, If you buy ottocoins, clients will pay you ottocoins price via this currency,';
		$lang['enter_comission'] = 'OTC / BTC';
		$lang['currenct_bitcoin_price'] = 'Current Ottocoin price';
		$lang['your_bitcoin_price'] = 'Your Ottocoin price';
		$lang['enter_comission_info'] = 'Enter your base price for OTC here, Example: If enter 210 and current Ottocoin price is 200 OTC / BTC, your price in ad will be 210 OTC / BTC or 0,005 BTC / OTC,';
		$lang['payment_instructions'] = 'Payment instructions';
		$lang['payment_instructions_info'] = 'If you sell bitcoins, here can enter your Ottocoin Address for payment to receive amount before you give bitcoins to client,<br>If you buy bitcoins, here can enter your bitcoin address which is available on your profile';
		...
		$lang['are_you_sure_reminder'] = 'Select action for reminder to trader';
		$lang['are_you_sure_release_bitcoins_1'] = 'Are you sure you want to release bitcoins to trader';
		$lang['this_action_can_be_undo'] = 'This action it can not be canceled when met once,';
		$lang['status'] = 'Status';
		// $lang['trade_info_1'] = 'Now you must wait trader send you %amount% %currency% to your <b>Ottocoin</b> account,';
		$lang['trade_info_1'] = 'This trade will auto deduct <b>%amount% %currency% + fee</b> from your BTC wallet once approved by trader,';
		// $lang['trade_info_2'] = '<b>IMPORTANT!</b> Please do not release your bitcoins before you are sure that your trader has paid amount,';
		$lang['trade_info_2'] = '<b>IMPORTANT!</b> Please remind the trader using our facility ( Reminder Trader and Chat ),';
		...
		$lang['trade_info_15'] = 'This trade was completed, You cant take any action more,';
		$lang['trade_info_5'] = 'You and trader have less than <b>%minutes% minutes</b> to complete this trade, If until after the time you or a dealer not complete this deal, it will automatically be completed and bitcoins will be returned,';
		$lang['chat'] = 'Chat';
		...
		$lang['trade_info_6'] = 'This trade will auto deduct <b>%amount% %currency%</b> from your account wallet once approved,';
		...
		$lang['trade_info_7'] = '<b>IMPORTANT!</b> Please carefully watch the timer of trade and ask extra time if u need it,,';
		$lang['trade_info_8'] = 'You and client have less than <b>%minutes% minutes</b> to complete this trade, If until after the time you or a dealer not complete this deal, it will automatically be completed and bitcoins will be returned,';
		...
		$lang['trade_info_9'] = 'This trade will auto deduct <b>%amount% %currency%</b> from your account wallet once approved by trader';
		...
		$lang['trade_info_11'] = '<b>IMPORTANT!</b> Please remind the trader using our facility ( Reminder Trader and Chat ),';
		$lang['are_you_sure_release_bitcoins_2'] = 'Are you sure you want to release bitcoins to client';
		// $lang['trade_info_12'] = 'Now you must wait client send you %amount% %currency% to your <b>%payment_method%</b> account,';
		$lang['trade_info_12'] = 'This trade will auto deduct <b>%amount% %currency% + fee</b> from your BTC wallet once approved';
		...
		$lang['trade_info_14'] = '<b>IMPORTANT!</b> Please carefully watch the timer of trade and ask extra time if u need it,';
		...
		$lang['close'] = 'Close';
		$lang['open'] = 'Open';
		$lang['current_ad_type_sell'] = 'Your current ad type is <b>Sell ottocoins</b>, thats mean clients will buy ottocoins from you,';
		$lang['current_ad_type_buy'] = 'Your current ad type is <b>Buy ottocoins</b>, thats mean clients will sell ottocoins to you,';
		$lang['delete'] = 'Delete';
		$lang['no'] = 'No';
		$lang['yes'] = 'Yes';
		$lang['ad_deleted'] = 'Your ad <b>%ad_id%</b> was deleted';
		$lang['ad_closed'] = 'Your ad <b>%ad_id%</b> was closed';
		$lang['ad_open'] = 'Your ad <b>%ad_id%</b> was Open';
		...
		$lang['btn_reminder_trade'] = 'Reminder trade';
		...
		$lang['btn_reminder_call'] = 'Call via Operator';
		$lang['btn_reminder_notif'] = 'Push Notification';
		$lang['btn_reminder_sms'] = 'Sms Trader';
		...
		$lang['success_5'] = 'Your report was sent to Ottocoin team, Report ID:';
		$lang['success_6'] = 'Thanks! Your feedback was added,';
		$lang['success_7'] = 'Thank you! Trade is Completed",';
		...
		$lang['success_14'] = 'Amount <b>%orig_amount%</b> was sent to <b>%recipient%</b>, Received Amount <b>(%amount%)</b> Transaction Fee <b>(%transaction_fee%)</b>';
		...
		$lang['success_19'] = 'Your Address was changed successfully,';
		...
		$lang['info_10'] = 'Still no have Referral,';
		$lang['info_11'] = 'Your request was send successfully,';
		$lang['info_12'] = 'Your push notification was send successfully,';
		$lang['info_13'] = 'Your Call was send successfully,';
		$lang['info_14'] = 'Your Sms was send successfully,';
		$lang['info_15'] = 'Are you sure you want to Close advertisement,';
		$lang['info_16'] = 'Are you sure you want to Open advertisement,';
		$lang['info_17'] = 'Extratime was Approved,';

		// Error
		$lang['error_1'] = 'Please enter your amount to continue trade,';
		$lang['error_2'] = 'Please enter your payment data,';
		$lang['error_3'] = 'Minimal amount for trade is %min_amount% OTC,';
		$lang['error_4'] = 'Maximum amount for trade is %max_amount% OTC,';
		//  Only xxxx BTC , Click here to deposit bitcoins
		// $lang['error_6'] = 'You cant enter more than %userbalance% BTC, <a href="',base_url(),'transaction/btc">Click here</a> to deposit bitcoins,';
		$lang['error_6'] = 'You have limited fund to do the transaction, Only %userbalance% BTC available, <a href="'.base_url().'transaction/btc">Click here</a> to deposit bitcoins,';
		// $lang['error_50'] = 'You cant enter more than %userbalance% OTC, <a href="',base_url(),'transaction/otc">Click here</a> to deposit ottocoins,';
		$lang['error_50'] = 'You have limited fund to do the transaction, Only %userbalance% OTC available, <a href="'.base_url().'transaction/otc">Click here</a> to deposit ottocoins,';
		$lang['error_5'] = 'Trader (%username%) not have enough bitcoins in stock, You can enter an amount %amount% BTC or less,';
		$lang['error_51'] = 'Trader (%username%) not have enough ottocoins in stock, You can enter an amount %amount% OTC or less,';
		...
		$lang['error_16_2'] = 'Enter maximum trade amount must be greater or equal than minimal trade amount,';
		...
		$lang['error_48'] = 'Minimal amount for withdrawal is %min_amount% OTC,';
		$lang['error_37'] = 'Please enter recipient address,';
		$lang['error_38'] = 'Minimal amount for withdrawal is %min_amount% BTC,';
		$lang['error_49'] = 'Minimal amount for withdrawal is %min_amount% OTC,';
		...
		$lang['estimated_transaction_fee'] = 'Estimated Transaction Fee';
		$lang['btn_generate_address'] = 'Generate New Address';
		$lang['this_action_can_be_undo_2'] = 'This action it can not be canceled when met once,';
		$lang['are_you_sure_generate_address'] =  'Are you sure you want to generate new address';
		$lang['btn_yes_generate_address'] = 'Yes, Generate new address';

		$lang['signup_date'] = 'Register Date';
		$lang['subscribe_dailyprice'] = 'Subscribe Daily Price';
		$lang['btn_update_profile'] = 'Update Profile';

		$lang['btn_extratime'] = 'Extra Time';
		$lang['btn_extratime_approve'] = 'Extra Time Approve';
		$lang['are_you_sure_extratime'] = 'Are you sure you want to request Extra Time to client';
		$lang['are_you_sure_extratime_approve'] = 'Are you sure you want to Approve Extra Time from trader';
		$lang['btn_yes_extratime'] = 'Yes, request extra time';
		$lang['btn_yes_extratime_approve'] = 'Yes, Approve extra time';
